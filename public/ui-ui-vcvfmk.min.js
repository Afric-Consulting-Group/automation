...
Version: 1
Updated: 2026-01-28T09:36:00.000Z
Author: Peter Širka
...
Component: j-Detail
Version: 1
Updated: 2026-01-15T08:34:00.000Z
Author: Peter Širka
...
Component: j-DragDropElement
Version: 1
Updated: 2025-05-13T10:00:03.000Z
Author: Michal Capo
...
Component: j-Filter
Version: 1
Updated: 2023-01-31T09:15:04.000Z
Author: Peter Širka
...
Component: j-iFrameViewer
Version: 1
Updated: 2024-10-09T20:50:00.000Z
Author: Peter Širka
...
Version: 1
Updated: 2025-09-19T07:30:00.000Z
Author: Peter Širka
...
Component: j-Restart
Version: 1
Updated: 2025-03-19T08:23:00.000Z
Author: Peter Širka
...
Component: j-ServerList
Version: 1
Updated: 2025-08-13T14:00:00.001Z
Author: Peter Širka
...
Component: Tangular-Badge
Version: 1
Updated: 2025-03-24T10:11:03.000Z
Author: Peter Širka
...
.ui-dragdropelement{min-height:16px;position:relative}.ui-dragdropelement-area{background-color:rgba(229,229,229,0.3) !important;position:absolute;inset:0;border:1px dashed #000;border-radius:var(--radius);text-align:center;display:grid;place-content:center}.ui-dragdropelement-area span{color:#000;font-size:14px}
...
.ui-filter{z-index:20;position:absolute;background-color:#FFF;border:1px solid #DEDEDE;border-radius:var(--radius);width:280px;box-shadow:0 2px 12px rgba(0,0,0,0.05);opacity:0;transform:scale(0.3);transition:all 0.2s;transform-origin:left top}.ui-filter-visible{opacity:1;transform:scale(1)}.ui-filter-item{height:27px;border-top:1px solid #E0E0E0}.ui-filter-item:first-child{border-top:0}.ui-filter-item-label{float:left;width:33%;text-overflow:ellipsis;white-space:nowrap;overflow:hidden;font-size:11px;line-height:26px;padding:0 5px;color:gray}.ui-filter-item-value{margin-left:33%;border-left:1px solid #E0E0E0;padding:0;height:27px;overflow:hidden}.ui-filter-placeholder{color:#A0A0A0;position:absolute;font-size:11px;height:26px;line-height:27px;margin-left:5px;cursor:pointer}.ui-filter-item-icon{float:right;width:30px;height:27px;font-size:11px;text-align:center;line-height:27px;border-left:1px solid #E0E0E0}.ui-filter-icon-click{cursor:pointer}.ui-filter-item-input{margin-right:30px}.ui-filter-item input{border:0;width:100%;outline:0;background-color:#FFF;font-size:11px;height:25px;color:#000;margin:0;padding:0 4px;line-height:25px}.ui-filter-checkbox{width:15px;height:15px;text-align:center;padding:2px 0 0;border:1px solid #E0E0E0;border-radius:var(--radius);font-size:10px;margin:6px 0 0 5px;cursor:pointer}.ui-filter-checkbox i{display:none}.ui-filter-checkbox-checked{background-color:#4285F4 !important;color:#FFF;border-color:#4285F4 !important}.ui-filter-checkbox-checked i{display:block}.ui-filter-option{font-size:11px;padding:0 5px;line-height:27px;cursor:pointer;text-overflow:ellipsis;overflow:hidden;white-space:nowrap;height:26px}.ui-filter-buttons{height:26px}.ui-filter-buttons button{border:0;background:#FFF;width:33%;font-size:12px;float:left;margin:0;padding:0;background-color:#F0F0F0;height:26px;outline:0}.ui-filter-buttons button i{margin-right:5px}.ui-filter-buttons button[name="reset"]{border-radius:0 0 0 var(--radius)}.ui-filter-buttons button[name="apply"]{background-color:#4285F4 !important;color:#FFF;font-weight:bold;width:34%}.ui-filter-buttons button[name="cancel"]{border-radius:0 0 var(--radius) 0}.ui-filter-buttons button:hover{opacity:0.8}
...
.ui-iframeviewer{position:fixed;left:0;top:0;z-index:10;background-color:#FFF}.ui-iframeviewer iframe{display:block;margin:0 auto}.ui-iframeviewer-fixed iframe{display:block;margin:0 auto;box-shadow:0 0 10px rgba(0,0,0,0.05);border:1px solid #E0E0E0;border-radius:var(--radius);background:#F0F0F0}.ui-iframeviewer-header{height:45px;border-bottom:1px solid #E0E0E0}.ui-iframeviewer-header > label{line-height:45px;padding-left:10px;font-weight:bold;color:#000}.ui-iframeviewer-header > span{float:right;line-height:44px;width:45px;text-align:center;color:red;cursor:pointer;border-left:1px solid #E0E0E0}.ui-iframeviewer-header > span:hover{background:#F8F8F8}
...
.ui-restart{position:absolute}.ui-restart a{display:block;background-color:#E73323;color:#FFF;padding:5px 10px;border-radius:var(--radius);font-size:11px;border-bottom:1px solid rgba(0,0,0,0.2)}.ui-restart i{margin-right:5px}
...
.ui-serverlist{border:1px solid #E0E0E0;border-radius:var(--radius);font-size:13px;background:#FFF;position:relative}.ui-serverlist-filter{display:flex;align-items:center;height:21px;gap:0;background:#FFF}.ui-serverlist-filter:last-child{border-right:1px solid #E0E0E0}.ui-serverlist-filter input{border:0;background:transparent;outline:0;font-size:11px;height:21px;padding:0 5px;margin:0;width:100%}.ui-serverlist-filter input[readonly]{cursor:pointer;user-select:none;caret-color:transparent}.ui-serverlist-filter input:disabled{background:#F9F9F9 repeating-linear-gradient(45deg,#FFF,#FFF 10px,#F9F9F9 10px,#F9F9F9 20px)}.ui-serverlist-clear{position:absolute;right:5px;top:4px;cursor:pointer;color:#D72727;visibility:hidden}.ui-serverlist-row{display:flex;border-bottom:1px solid #E0E0E0;align-items:center;border-right:1px solid #E0E0E0;gap:0}.ui-serverlist-row-empty{border-bottom:1px solid #F0F0F0;align-items:center;border-right:1px solid #E0E0E0;height:32px}.ui-serverlist-noscroll .ui-serverlist-rows{overflow-y:hidden}.ui-serverlist-noscroll .ui-scrollbar-y span{visibility:hidden}.ui-serverlist-items{margin-bottom:15px}.ui-serverlist-rows,.ui-serverlist-header{padding-right:15px}.ui-serverlist-rows{background:#FFF}.ui-serverlist-header{background:#F4F4F4;border-bottom:1px solid #E0E0E0}.ui-serverlist-th,.ui-serverlist-td{border:1px solid transparent;border-left-color:#E0E0E0;height:32px;line-height:32px;padding:0 5px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.ui-serverlist-tf{border-left:1px solid #E0E0E0;position:relative;background-color:#FFF}.ui-serverlist-tf-is input{padding-right:20px}.ui-serverlist-tf-is{background-color:rgb(255,245,167,0.26)}.ui-serverlist-tf-is .ui-serverlist-clear{visibility:visible}.ui-serverlist-th{height:36px;line-height:36px;font-weight:bold}.ui-serverlist-th > div{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.ui-serverlist-th.ui-serverlist-sort > div{padding-right:15px}.ui-serverlist-th:first-child,.ui-serverlist-td:first-child{border-left:0}.ui-serverlist-th{background:#F4F4F4;position:relative}.ui-serverlist-th > div i{margin-right:5px;color:#999}.ui-serverlist-rows .ui-serverlist-row:hover{background:#F8F8F8}.ui-serverlist-row.selected .ui-serverlist-number{visibility:visible}.ui-serverlist-container{overflow:scroll;-ms-overflow-style:none;scrollbar-width:none}.ui-serverlist-rows::-webkit-scrollbar{display:none}.ui-serverlist-rows{overflow:scroll;-ms-overflow-style:none;scrollbar-width:none}.ui-serverlist-number{width:40px;font-size:11px;color:#999;text-align:center}.ui-serverlist-checkbox{display:block;border:1px solid #D0D0D0;border-radius:var(--radius);width:16px;height:16px;line-height:14px;text-align:center;background:#FFF;cursor:pointer;font-size:11px}.ui-serverlist-checkbox i{visibility:hidden}.ui-serverlist-checkboxes .ui-serverlist-number:hover em{display:block}.ui-serverlist-checkboxes .ui-serverlist-number:hover span{display:none}.ui-serverlist-item.selected .ui-serverlist-checkbox{color:var(--color);border-color:var(--color)}.ui-serverlist-item.selected .ui-serverlist-checkbox i{visibility:visible !important}.ui-serverlist-item.selected .ui-serverlist-number span{display:none}.ui-serverlist-th-number{width:20px;justify-content:center;text-align:center}.ui-serverlist-th-number i{margin-right:0 !important;color:#000}.ui-serverlist-sort{cursor:pointer}.ui-serverlist-btn-sort{position:absolute;right:4px;top:0;color:#999}.ui-serverlist-left{text-align:left}.ui-serverlist-right{text-align:right}.ui-serverlist-center{text-align:center}.ui-serverlist-pagination{height:36px;line-height:36px;border-top:1px solid #E0E0E0;padding:0 5px}.ui-serverlist-pagination-pages{color:#999}.ui-serverlist-pagination-count{float:right;color:#999}.ui-serverlist-pagination input{width:50px;height:24px;line-height:24px;outline:0;text-align:center;border:0;margin-right:5px;font-size:12px;background:#F0F0F0;border-radius:var(--radius)}.ui-serverlist-pagination button{width:25px;border:0;background:#F0F0F0;transparent;padding:0;height:24px;border-radius:var(--radius);margin-right:5px;line-height:24px}.ui-serverlist-pagination button:hover{background:#F8F8F8}.ui-serverlist-pagination button:disabled,.ui-serverlist-pagination input:disabled{background:#F8F8F8;cursor:not-allowed;color:#999}.ui-serverlist-td.highlight{border-color:#156EE1}.ui-serverlist-row.highlight{background-color:rgb(255,245,167,0.26)}.ui-serverlist-noborder{border:0;border-radius:0}.ui-serverlist-th-number em{margin:10px 0 0 7px;border:1px solid #D0D0D0;border-radius:var(--radius);width:16px;height:16px;line-height:14px;text-align:center;background:#FFF;cursor:pointer;display:block;font-size:11px}.ui-serverlist-th-number em i{visibility:hidden}.ui-serverlist-th-number.selected em{display:block;border-color:var(--color)}.ui-serverlist-th-number.selected em i{visibility:visible;color:var(--color)}.ui-serverlist-pointer .ui-serverlist-row{cursor:pointer}.ui-serverlist-checkboxes .ui-serverlist-th-number{width:40px}.ui-serverlist-empty{position:absolute;left:0;right:0;text-align:center;font-size:12px;color:#999}.ui-serverlist-empty-container{position:relative}
...
COMPONENT('dragdropelement',function(self,config,cls){var area,timeoutid;self.readonly();self.destroy=function(){area.off('*').remove()};self.make=function(){var hidden=true,text='';if(config.text)text='<span>{0}</span>'.format(config.text);self.aclass(cls);self.append('<div class="{0}-area hidden">{1}</div>'.format(cls,text));area=self.find('.'+cls+'-area');var show=function(e){e.stopPropagation();e.preventDefault();if(config.disabled)return;if(timeoutid){clearTimeout(timeoutid);timeoutid=null}else{if(hidden){area.rclass('hidden');hidden=false}}};var hide=function(e){e.stopPropagation();e.preventDefault();if(config.disabled)return;if(!timeoutid){timeoutid=setTimeout(function(){area.aclass('hidden');timeoutid=null;hidden=true},100)}};var finish=function(e){if(config.disabled)return;self.EXEC(config.exec,e.originalEvent.dataTransfer.files,e,self)};area.on('dragenter dragover',show);area.on('drop dragleave',hide);area.on('drop',finish);self.event('dragenter dragover',show);self.event('drop dragleave',hide);self.event('drop',finish)}});
...
COMPONENT('iframeviewer',function(self,config,cls){var cls2='.'+cls,events={},is=false,iframe;self.singleton();self.blind();events.keydown=function(e){if(e.which===27)self.hide()};events.off=function(){if(events.is){events.is=false;$(W).off('keydown',events.keydown)}};events.on=function(){if(!events.is){events.is=true;$(W).on('keydown',events.keydown)}};self.make=function(){W.iframeviewerload=function(){self.opt&&self.opt.ready&&self.opt.ready(iframe[0]);SETTER('!loading/hide',1000)};self.aclass(cls+' hidden');self.append('<div class="{0}-container"><div class="{0}-header"><span><i class="ti ti-times"></i></span><label></label></div><div class="{0}-body"><iframe src="about:blank" frameborder="0" onload="iframeviewerload()"></iframe></div></div>'.format(cls));iframe=self.find('iframe');self.find(cls2+'-header > span').on('click',self.hide);self.on('resize + resize2',self.resize)};self.resize=function(){if(is){var css={};css.width=WW;css.height=WH;self.css(css);css={};css.height=WH-(self.find(cls2+'-header').height()||45)-(self.opt.margin*2);if(self.opt.margin)css['margin-top']=self.opt.margin+'px';iframe.css(css)}};self.hide=function(){if(is){self.aclass('hidden');is=false;events.off();self.opt.close&&self.opt.close();self.opt=null;iframe.attr('src','about:blank')}};self.open=function(opt){if(!opt.margin)opt.margin=0;if(opt.esc)events.on();else events.off();self.opt=opt;is=true;self.tclass(cls+'-fixed',!!opt.width&&opt.width!=='100%');self.find('label').text(opt.name);if(opt.html){if(opt.html.indexOf('<body')===-1)opt.html='<!DOCTYPE html><html><head><meta charset="utf-8" /></head><body style="font-family:Arial;font-size:14px;margin:0;padding:0">'+opt.html+'</body></html>';iframe.attr('src',opt.url).css('width',opt.width||'100%');var doc=iframe[0].contentWindow.document;doc.open();doc.write(opt.html);doc.close()}else iframe.attr('src',opt.url).css('width',opt.width||'100%');self.resize();self.rclass('hidden');if(!opt.html)iframe.focus()}});
...
COMPONENT('restart','url:?reload=1;top:75;right:20',function(self,config,cls){self.singleton();let is=false;let html;self.make=function(){let css={};if(config.top)css.top=config.top+'px';if(config.bottom)css.bottom=config.bottom+'px';if(config.right)css.right=config.right+'px';if(config.left)css.left=config.left+'px';self.aclass('hidden '+cls);self.css(css);html=self.html();self.empty()};self.setter=function(value){if(!is&&value){is=true;self.html('<a href="{0}">{1}</a>'.format(config.url,html));self.rclass('hidden')}}});
...
COMPONENT('serverlist','colwidth:150;pluralizepages:# pages,# page,# pages,# pages;pluralizeitems:# items,# item,# items,# items;margin:0;scrolltop:1;filter:Filter;prop:html;display:1;empty:No records found.',function(self,config,cls){var cls2='.'+cls,nodes={},filtercache={sort:'',filter:{},page:1,pages:1},Tth=Tangular.compile('<div class="{0}-th{{ if value.sorting}} {0}-sort{{ fi}}{{ if value.alignheader}} {0}-{{ value.alignheader}}{{ fi}}" style="width:{{ value.width}}px" data-id="{{ value.id}}">{{ if value.sorting}}<span class="{0}-btn-sort"><i class="ti {{ if value.sort === \'asc\' }}ti-angle-up{{ else if value.sort === \'desc\' }}ti-angle-down{{ else}}ti-arrows-v{{ fi}}"></i></span>{{ fi}}<div>{{ if value.icon}}<i class="{{ value.icon}}"></i>{{ fi}}{{ value.name | raw}}</div></div>'.format(cls));var Ttf=Tangular.compile('<div class="{0}-tf{{ if value.filter}} {0}-tf-is{{ fi}}" style="width:{{ value.width}}px"><i class="{0}-clear ti ti-times"></i><input data-name="{{ value.id}}"{{ if !value.filtering}} disabled{{ fi}}{{ if value.placeholder}} placeholder="{{ value.placeholder}}"{{ fi}}{{ if value.filter}} value="{{ value.filter}}"{{ fi}}{{ if cls}} class="{{ cls}}"{{ fi}} autocomplete="new-password" role="combobox" aria-expanded="true" aria-invalid="false" aria-autocomplete="list" aria-haspopup="false" autocapitalize="off" autocorrect="off" spellcheck="false"{{ if value.dirsource}} readonly{{ fi}} /></div>'.format(cls));var Titem=null,scrollY=0,scrollX=0,emptyrows=0,rgba=function(hex,alpha){if(hex&&/^#([A-Fa-f0-9]{3}){1,2}$/.test(hex)){let c=hex.substring(1).split('');if(c.length===3)c=[c[0],c[0],c[1],c[1],c[2],c[2]];c='0x'+c.join('');return'rgba('+[(c>>16)&255,(c>>8)&255,c&255].join(',')+','+alpha+')'}return'rgba(0,0,0,'+alpha+')'};self.make=function(){let scr=self.find('scr'+'ipt').html();Titem=scr?Tangular.compile(scr):null;self.empty();self.aclass(cls);self.append('<div class="{0}-container"><div class="{0}-table"><div class="{0}-header noscrollbar"></div><div class="{0}-empty-container"><div class="{0}-empty hidden"><i class="ti ti-database mr5"></i>{1}</div></div><div class="{0}-rows"><div class="{0}-items"></div></div></div></div><div class="{0}-pagination"><span class="{0}-pagination-count">0</span><button name="first" disabled><i class="ti ti-angle-double-left"></i></button><button name="prev" disabled><i class="ti ti-angle-left"></i></button><input autocomplete="new-password" spellcheck="false" role="combobox" aria-expanded="true" aria-invalid="false" aria-autocomplete="list" autocapitalize="off" autocorrect="off" disabled value="1" /><button name="next" disabled><i class="ti ti-angle-right"></i></button><button name="last" disabled><i class="ti ti-angle-double-right"></i></button><span class="{0}-pagination-pages">0</span></div>'.format(cls,config.empty));config.noborder&&self.aclass(cls+'-noborder');config.checkbox&&self.aclass(cls+'-checkboxes');if(config.click||config.cell)self.aclass(cls+'-pointer');nodes.container=self.find(cls2+'-container');nodes.table=self.find(cls2+'-table');nodes.header=self.find(cls2+'-header');nodes.rows=self.find(cls2+'-rows');nodes.data=self.find(cls2+'-items');nodes.sizer=self.find(cls2+'-sizer');nodes.empty=self.find(cls2+'-empty');nodes.pagination={};let pe=self.find(cls2+'-pagination');nodes.pagination.element=pe;nodes.pagination.first=pe.find('button[name="first"]');nodes.pagination.last=pe.find('button[name="last"]');nodes.pagination.prev=pe.find('button[name="prev"]');nodes.pagination.next=pe.find('button[name="next"]');nodes.pagination.page=pe.find('input');nodes.pagination.pages=pe.find(cls2+'-pagination-pages');nodes.pagination.count=pe.find(cls2+'-pagination-count');nodes.scrollbarY=SCROLLBAR(nodes.rows,{visibleY:true,shadow:config.scrollbarshadow,orientation:'y',controls:self.element,marginY:50,wrap:false});self.resizeforce();self.event('click',cls2+'-item',function(e){if(!config.click)return;let target=e?e.target:null;if(target&&target.tagName==='A'||$(target).closest('a').length)return;let el=$(this);nodes.rowhighlight&&nodes.rowhighlight.rclass('highlight');nodes.rowhighlight=el;let model=self.get();let row=model.items[+el.attrd('index')];el.aclass('highlight');config.click&&self.SEEX(config.click,row,el)});nodes.pagination.first.on('click',()=>self.page(1));nodes.pagination.prev.on('click',()=>self.page(filtercache.page-1));nodes.pagination.next.on('click',()=>self.page(filtercache.page+1));nodes.pagination.last.on('click',()=>self.page(filtercache.pages));nodes.pagination.page.on('change',function(){let page=+this.value;if(!isNaN(page)&&page>=0)self.page(page)});nodes.header.on('change','input',()=>self.filter());nodes.rows.on('scroll',()=>scrollY=nodes.rows[0].scrollTop);nodes.container.on('scroll',()=>scrollX=nodes.container[0].scrollLeft);self.event('click',cls2+'-th-number',function(){let el=$(this);let model=self.get();el.tclass('selected');let selected=el.hclass('selected');for(let m of model.items)m.$selected=selected;nodes.data.find('> '+cls2+'-item').tclass('selected',selected);self.selected()});self.event('click',cls2+'-checkbox',function(e){if(!config.checkbox)return;e.preventDefault();e.stopPropagation();let el=$(this).closest(cls2+'-item');let index=+ATTRD(el,'index');let model=self.get();let row=model.items[index];el.tclass('selected');row.$selected=el.hclass('selected');self.selected()});self.event('click',cls2+'-sort',function(e){let model=self.get();let el=$(this);let id=ATTRD(el);let column=model.columns.findItem('id',id);switch(column.sort){case'asc':column.sort='';break;case'desc':column.sort='asc';break;default:column.sort='desc';break}for(let m of model.columns){if(m.sorting&&m!==column&&m.sort)m.sort=''}filtercache.sort=column.sort?(column.id+'_'+column.sort):'';config.exec&&self.EXEC(config.exec,'sort',filtercache.filter,filtercache.sort,filtercache.page)});self.event('click',cls2+'-clear',function(e){e.stopPropagation();e.preventDefault();let model=self.get();let el=$(this).closest(cls2+'-tf');let input=el.find('input');input.val('');self.filter()});self.event('click',cls2+'-dirsource',function(e){e.stopPropagation();e.preventDefault();let model=self.get();let input=$(this);let opt={};let column=model.columns.findItem('id',input.attrd('name'));opt.element=input;opt.items=column.dirsource;opt.offsetY=24;opt.offsetX=2;opt.callback=function(selected){input.val(selected.name);self.filter()};SETTER('directory/show',opt)})};self.resize=function(){setTimeout2(self.ID,self.resizeforce,50)};self.resizeforce=function(){if(!config.height&&!config.parent)return;let height=0;if(config.height){height=config.height-config.margin}else{let parent=self.parent(config.parent);height=parent.height()-config.margin}let rowsheight=height-36-36-22;emptyrows=Math.ceil(rowsheight/33);nodes.container.css('height',height-35);nodes.rows.css('height',rowsheight);nodes.scrollbarY&&nodes.scrollbarY.resize();nodes.empty.css({top:height/2-50});if(config.display)self.rclass2('d-').aclass('d-'+WIDTH(self.element))};self.filter=function(){let model=self.get();let inputs=nodes.header.find('input');let obj={};for(let m of inputs){if(!m.disabled){let name=m.getAttribute('data-name');let col=model.columns.findItem('id',name);if(col){let val=m.value;col.filter=val;if(col.dirsource)val=val==null||val==''?null:col.dirsource.findValue('name',val,'id');if(val!=null&&val!=='')obj[name]=val}}}filtercache.filter=obj;config.exec&&self.EXEC(config.exec,'filter',filtercache.filter,filtercache.sort,filtercache.page)};self.page=function(page){if(page>filtercache.pages)page=filtercache.pages;else if(page<0)page=1;filtercache.page=page;config.exec&&self.EXEC(config.exec,'page',filtercache.filter,filtercache.sort,filtercache.page)};self.selected=function(){let model=self.get();let selected=[];for(let m of model.items){if(m.$selected)selected.push(m)}config.checked&&self.SEEX(config.checked,selected)};self.setter=function(value,path,flags){if(!value){config.exec&&self.EXEC(config.exec,'filter',filtercache.filter,filtercache.sort,filtercache.page);return}let builder=[];let filter=[];let width=40;builder.push(('<div class="{0}-th {0}-th-number">'+(config.checkbox?'<em><i class="ti ti-check"></i></em>':'')+'</div>').format(cls));filter.push('<div class="{0}-th-number">&nbsp;</div>'.format(cls));filtercache.page=value.page||1;filtercache.pages=value.pages||1;if(!value.count)value.count=0;for(let col of value.columns){if(col.filtering==true)col.placeholder=config.filter;if(!col.width)col.width=config.colwidth;switch(col.align){case 0:col.align='left';break;case 1:col.align='center';break;case 2:col.align='right';break}switch(col.alignheader){case 0:col.alignheader='left';break;case 1:col.alignheader='center';break;case 2:col.alignheader='right';break}switch(col.alignfilter){case 0:col.alignfilter='left';break;case 1:col.alignfilter='center';break;case 2:col.alignfilter='right';break}if(!col.alignheader&&col.align)col.alignheader=col.align;if(!col.alignfilter&&col.align)col.alignfilter=col.align;width+=col.width+2;let ccls='';if(col.dirsource)ccls+=(ccls?' ':'')+'{0}-dirsource';if(col.alignfilter)ccls+=(ccls?' ':'')+'{0}-'+col.alignfilter;let obj={value:col,cls:ccls.format(cls)};builder.push(Tth(obj));filter.push(Ttf(obj))}width+=15;nodes.header.html('<div class="{0}-width"><div class="{0}-row">{1}</div><div class="{0}-filter">{2}</div></div>'.format(cls,builder.join(''),filter.join('')));builder.length=0;let model={};for(let i=0;i<value.items.length;i++){let row=value.items[i];let html='<div class="{0}-item{1}" data-index="{2}">'.format(cls,row.$selected?' selected':'',i);if(config.checkbox)html+='<div class="{0}-checkbox"><i class="ti ti-check"></i></div>'.format(cls);model.value=row;html+=Titem?Titem(model,value):row[config.prop]||'';builder.push(html+'</div>')}let diff=emptyrows-value.items.length;nodes.pagination.pages.html(value.pages.pluralize(config.pluralizepages));nodes.pagination.count.html(value.count.pluralize(config.pluralizeitems));nodes.pagination.first.prop('disabled',value.page<=1);nodes.pagination.last.prop('disabled',value.page>=value.pages);nodes.pagination.prev.prop('disabled',value.page<=1);nodes.pagination.next.prop('disabled',value.page>=value.pages);nodes.pagination.page.prop('disabled',value.pages<=1).val(value.page+'');nodes.empty.tclass('hidden',!!value.items.length);nodes.data.html(builder.join(''));nodes.header.find(cls2+'-width').css({width:width});self.resizeforce();self.selected();if(config.scrolltop&&!flags.noscroll){setTimeout(function(){nodes.scrollbarY.resize();nodes.scrollbarY.scrollTop(0)},500)}}});
...
Thelpers.badge=function(value,size){if(!value)return'';let colors=DEF.badgecolors||['#1abc9c','#2ecc71','#3498db','#9b59b6','#34495e','#16a085','#2980b9','#8e44ad','#2c3e50','#f1c40f','#e67e22','#e74c3c','#d35400','#c0392b'];if(!(value instanceof Array))value=[value];let output='';for(let m of value){let num=0;for(let i=0;i<m.length;i++)num+=m.charCodeAt(i);output+='<span class="badge badge-{2} mr5" style="background-color:{0}">{1}</span>'.format(colors[num%colors.length],m,size||'medium')}return output};
